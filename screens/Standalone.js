            ...
            <ScrollView>
                ...
                <View style={styles.type}>
                    ...
                    <TouchableHighlight
                        ...
                        style={styles.touchbtn} onPress={() => props.navigation.navigate('Calculator')}>
                        <Text style={styles.touctext}>laundry calculator</Text>
                    </TouchableHighlight>
                </View>
                <View style={styles.view}>
                    <TouchableHighlight style={{ ...styles.touch, borderColor: red ? r1 : r2 }} onPress={inValue}>
                        <Text style={{...styles.touctext,color:red ? r1 : r2}}>Clothes</Text>
                    </TouchableHighlight>

                    <TouchableHighlight style={styles.touch }  onPress={onChange}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', }}>
                    ...
                    <TouchableHighlight style={{ borderWidth: 1, height: 50, width: 200, alignItems: 'center', alignContent: 'center', borderRadius: 4 }} >
                        <Text style={styles.listtext} >SELECT LOAD TYPE</Text>
